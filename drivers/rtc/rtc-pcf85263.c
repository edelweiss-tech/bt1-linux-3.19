...
#ifdef CONFIG_OF
static const struct of_device_id of_dev_ids[] = {
  { .compatible = "nxp,pcf85263" },
  {}
};
MODULE_DEVICE_TABLE(of, of_dev_ids);
#endif
...
static struct i2c_driver pcf85263_driver = {
  .driver   = {
    .name   = DRIVER_NAME,
    .owner = THIS_MODULE,
    .of_match_table = of_match_ptr(of_dev_ids),
  },
...
MODULE_AUTHOR("Konstantin Kirik <snegovick@uprojects.org>");
