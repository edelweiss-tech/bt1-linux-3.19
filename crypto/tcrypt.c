...
static int do_test(const char *alg, u32 type, u32 mask, int m)
{
	...
	case 120:
		ret += tcrypt_test("ecb(gost)");
		ret += tcrypt_test("cbc(gost)");
		ret += tcrypt_test("cfb(gost)");
		break;
	...
	case 212:
		test_acipher_speed("ecb(gost)", ENCRYPT, sec, NULL, 0,
				speed_template_32);
		test_acipher_speed("ecb(gost)", DECRYPT, sec, NULL, 0,
				speed_template_32);
		test_acipher_speed("cbc(gost)", ENCRYPT, sec, NULL, 0,
				speed_template_32);
		test_acipher_speed("cbc(gost)", DECRYPT, sec, NULL, 0,
				speed_template_32);
		test_acipher_speed("cfb(gost)", ENCRYPT, sec, NULL, 0,
				speed_template_32);
		test_acipher_speed("cfb(gost)", DECRYPT, sec, NULL, 0,
				speed_template_32);
		 break;
